...
# defines the "VOXFORGE_ROOT" variable - the location to store data 
source ./path.sh

#DATA_SRC="http://www.repository.voxforge1.org/downloads/SpeechCorpus/Trunk/Audio/Main/16kHz_16bit"
DATA_SRC="http://www.repository.voxforge1.org/downloads/pt/Trunk/Audio/Main/16kHz_16bit/"
DATA_TGZ=${VOXFORGE_ROOT}/tgz
DATA_EXTRACT=${VOXFORGE_ROOT}/extracted
